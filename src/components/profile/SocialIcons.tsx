/** Inline SVG icons for social platforms — outline style */

export function TobeFanIcon({ size = 20 }: { size?: number }) {
  return (
...
export function LinkedInIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <text x="6" y="17" fontSize="11" fontWeight="700" fill="currentColor" stroke="none" fontFamily="system-ui">in</text>
    </svg>
  );
}
