...
export function ContentHubSection() {
  return (
    <section className="w-full bg-white overflow-hidden" style={{ paddingTop: 32, paddingBottom: 80 }}>
      {/* Full-bleed Passion Wall */}
      <PassionWall />

      <div className="max-w-[1200px] mx-auto px-6 text-center" style={{ marginTop: 32 }}>
        <Link
          to="/feed"
